// src/pages/EstadisticaPage/TablaVentas.jsx
import React, { useState, useEffect } from "react";
import { formatCLP, formatNumber } from "./formatters";
import axios from "../../api/axios";

const TablaVentas = ({ periodo = "anual" }) => {
    ...
    const cargarDatos = async () => {
      try {
        ...
        const response = await axios.get(
          `/estadisticas/ventas?periodo=${periodo}`
        );
          ...
          <tbody className="divide-y divide-gray-800">
            {datos.map((item, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-green-500 font-medium text-right">
